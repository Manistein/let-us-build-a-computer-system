...
xst -ifn xst.scr
move adc_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\adc_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc adc_pll_exdes.ucf adc_pll_exdes

echo 'Running map'
map -timing -pr b adc_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm adc_pll_exdes -w routed.ncd routed.v
cd ..
