...
xst -ifn xst.scr
move chip_pll_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\chip_pll_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc chip_pll_exdes.ucf chip_pll_exdes

echo 'Running map'
map -timing -pr b chip_pll_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm chip_pll_exdes -w routed.ncd routed.v
cd ..
